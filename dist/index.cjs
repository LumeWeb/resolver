...
var require_assert = __commonJS({
  "node_modules/bsert/lib/assert.js"(exports, module2) {
    ...
    function testError(err, expected, message, func) {
      ...
      if (expected.prototype !== void 0 && err instanceof expected) return true;
    ...
    function recurse(a, b, cache) {
      if (isMap(a)) {
        ...
        if (keys2.size !== a.size) return false;
...
var Eip137 = class extends SubResolverBase {
  ...
  getConnection(chain) {
    let apiUrl = new import_url.default(
      `https://${this.resolver.getPortal()}/pocketdns`
    );
    if (import_url.default.URLSearchParams) {
      let params = new import_url.default.URLSearchParams();
